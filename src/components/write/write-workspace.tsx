    ...
    >
      <div style={{ maxWidth: 1080, margin: "0 auto", padding: "24px 28px" }}>
        ...
        <Text size="sm" c="dimmed" mb="lg">
          Write the statement you want to run, then generate a verify SELECT
          from it (editable) so a reviewer can see exactly the rows it affects.
          On approval environments it is submitted for a second person to
          review; on direct environments it runs immediately. Track it under{" "}
